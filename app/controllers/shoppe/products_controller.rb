module Shoppe
  class ProductsController < Shoppe::ApplicationController
    ...
    def safe_params
      params[:product].permit(:name, :sku, :permalink, :description, :short_description, :weight, :price, :price_including_tax, :cost_price, :tax_rate_id, :stock_control, :default_image_file, :data_sheet_file, :active, :featured, :in_the_box, :price_including_tax, :product_attributes_array => [:key, :value, :searchable, :public], :product_category_ids => [])
    end
